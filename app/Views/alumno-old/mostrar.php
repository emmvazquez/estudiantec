                ...
                <table class="table  table-bordered table-striped table-sm" style="font-size:10pt">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('alumno/editar/'.$key->id);  ?>" class="btn btn-primary">Editar</a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <?php for($i=1;$i<=$pagina;$i++ ): ?>
                    <li class="page-item"><a class="page-link" href="<?= base_url('index.php/alumno/mostrar/'.$i)?>"><?= $i?></a></li>
                <?php endfor ?>
                </ul>
                </nav>
            </div>
...
<div class="modal fade" id="exampleModal<?php echo $alumno->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger" href="<?= base_url('alumno/borrar/'.$alumno->id);  ?>" >Eliminar</a>
      </div>
    </div>
  </div>
</div>
